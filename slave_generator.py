...
def get_main():
    return r'''extern crate tvm_runtime;
...
#[path = "/home/lifabing/sgx/cluster-inference/support/mod.rs"]
mod support;
...
sgx-crypto = { path = "/home/lifabing/sgx/cluster-inference/sgx-crypto" }
ra-common = { path = "/home/lifabing/sgx/cluster-inference/ra-common" }
ra-enclave = { path = "/home/lifabing/sgx/cluster-inference/ra-enclave" }
...
def get_address(index, model_path):
    ...
    "client_address": "127.0.0.1:'''+ str(7710+index) + r'''",
...
if __name__ == "__main__":
    model_path = sys.argv[1] if sys.argv[1] else "/home/lifabing/sgx/cluster-inference/model/resnet50"
    num_models = len(os.listdir(model_path))
    target_dir = sys.argv[2] if sys.argv[2] else "/home/lifabing/sgx/"
